...
export const rooms = [
  {
    id: 1,
    title:
      "Newly Built Apartment in Dha fifteen, right in front of the beach, Dha Phase V, Karachi",
  ...
  {
    id: 2,
    title: "New Sensational Accommodation in Karachi",
    property_type: "whole house",
    max_capacity: 4,
    bedrooms: 1,
    beds: 3,
  ...
  },
  {
    id: 4,
    title:
      "House in the middle of a mandarin orange field, Tangerine Hanga Room 202",
    property_type: "whole house",
    max_capacity: 2,
    bedrooms: 1,
    beds: 2,
