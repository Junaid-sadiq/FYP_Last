export function seedDatabase1(firebase) {
  const AvailAmenities = [
    {
      title: "Basic",
      data: [
        {
          name: "Wifi",
          description: "Continuous acess in the listing",
        },
        {
          name: "Dryer",
    ...
    },
    {
      ...
      data: [
        {
          name: "Keypad",
          description: "Check yourself into the home with a door code",
        },
        {
