      ...
      <MainWrapper>
        <Flex>
          <View>
            ...
            <Typography.P color={colors.gray}>13 years or older</Typography.P>
          </View>
        ...
        <Flex>
          <View>
            ...
            <Typography.P color={colors.gray}>2-12count</Typography.P>
          </View>
        ...
        <Flex>
          <View>
            <Typography.H3>child</Typography.H3>
            <Typography.P color={colors.gray}>2 under the age of</Typography.P>
          </View>
